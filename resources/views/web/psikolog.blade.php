...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <div class="contain" style="padding-top: 40px;">
        ...
        @php
            $psikologChunks = $psikologs->chunk(3);
        @endphp

        <div id="psikologCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">

                @foreach ($psikologChunks as $index => $psikologChunk)
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#psikologCarousel" data-bs-slide="prev"
                style="color: #294587">
            ...
            <button class="carousel-control-next" type="button" data-bs-target="#psikologCarousel" data-bs-slide="next"
                style="color: #294587">
